...
labels:
  ...
  - Docker
  - Tools for Data Science (Pandas, Numpy, xArray)
  - Conda Environment Setup
summary: As part of the Karamperidou Research Group, I was tasked to develop a hurricane simulator for the pacific ocean which predicts where a hurricane will go based on the winds, the sea surface temperature, and the location of pressure systems. 

---

<img class="ui medium right floated rounded image" src="/images/hurricane-simulator-cover.png">
